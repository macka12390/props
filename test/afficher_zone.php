        ...
        <div class="col-lg-12 grid-margin stretch-card mt-5">
                <div class="card">
                  <div class="row mt-5">
                    ...
                    <h4 class="card-title col-2">LISTE ZONE</h4>
                    <a href="ajout-zone.php" class="btn btn-outline-primary col-2 mr-5">Ajouter</a>
                    <a href="lister-zone-critic.php" class="btn btn-outline-danger col-2">Lister cas critique</a>
                    </p>
