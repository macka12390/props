                  ...
                  <div class="card-body mt-4">
                    ...
                    <form class="forms-sample" method="POST">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="PAYS" name="nomPays">
                      </div>
                     
                     
                      <button type="submit" name="AjouterPays" class="btn btn-primary mr-2">AJOUTER</button>
