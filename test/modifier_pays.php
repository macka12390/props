...
if(isset($_GET["idm"])){
    extract($_GET);
    $pays=$entityManager->getRepository(Pays::class)->find($idm);
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="delete">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" value="<?=$pays->getNom_pays() ?>" class="form-control" id="exampleInputUsername1" placeholder="PAYS" name="nomPays">
                      </div>
